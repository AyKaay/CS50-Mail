...
function load_mailbox(mailbox) {
  ...
  .then((emails) => {
    ...
    emailDiv.innerHTML = `
      <div class="row">
        <span class="sender "><i class="bi bi-person-circle"></i> &nbsp; ${email.sender}</span>
        <span class="subject "><i class="bi bi-envelope"></i> &nbsp; ${email.subject}</span>
        <span class="timestamp "><i class="bi bi-calendar"></i> &nbsp; ${email.timestamp}</span>
      </div>
    `;
